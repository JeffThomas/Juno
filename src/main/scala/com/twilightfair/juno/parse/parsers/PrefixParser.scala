...
import com.twilightfair.juno.parse.elements.configs.{PrefixConfig, InfixConfig, ElementConfig}

/**
 * Created by jthomas on 12/12/13.
 */
case class PrefixParser(override val element: ElementFactory, override val precedence: Int)
